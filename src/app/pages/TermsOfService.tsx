          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                본 약관은 플로(이하 "회사")가 제공하는 Pangea 서비스(이하 "서비스")의 이용과 관련하여 
            ...
            <section className="mb-8">
              ...
              <ul className="list-decimal pl-6 text-gray-700 space-y-3">
                <li>
                  <strong>"서비스"</strong>란 회사가 제공하는 RPA 기반 렌터카 리스크 관리 플랫폼 "Pangea" 및 
                  관련된 제반 서비스를 의미합니다.
                </li>
                <li>
                ...
                <li>
                  <strong>"회원"</strong>이란 회사와 서비스 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 자를 말합니다.
                </li>
                <li>
                  <strong>"비회원"</strong>이란 회원에 가입하지 않고 회사가 제공하는 서비스를 이용하는 자를 말합니다.
                </li>
                <li>
                  <strong>"데모"</strong>란 회사가 제공하는 무료 체험 서비스를 의미합니다.
                </li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">제3조 (약관의 명시와 개정)</h2>
              <div className="space-y-4">
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ① 회사는 이 약관의 내용과 상호, 영업소 소재지, 대표자의 성명, 사업자등록번호, 연락처 등을 
                    이용자가 알 수 있도록 서비스 초기화면에 게시합니다.
                  </p>
                </div>
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ② 회사는 약관의 규제에 관한 법률, 전자거래기본법, 전자서명법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 text-gray-700 space-y-2">
                    <li>렌터카 사업 리스크 자동 감지 및 관리</li>
                    <li>사업 성과 지표화 및 분석</li>
                    <li>금융사 연계 서비스</li>
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ② 회사는 서비스의 내용을 변경할 경우 그 내용 및 제공일자를 명시하여 
                    현재 서비스를 제공하고 있는 화면에 공지합니다.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    이용자 또는 제3자가 입은 손해에 대하여 배상합니다. 단, 회사가 고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니합니다.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-decimal pl-6 text-gray-700 space-y-2 mt-2">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ② 회사는 불특정다수 회원에 대한 통지의 경우 1주일이상 서비스 게시판에 게시함으로서 
                    개별 통지에 갈음할 수 있습니다.
                  </p>
                </div>
              </div>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">제9조 (이용자의 의무)</h2>
              <div className="space-y-4">
                <div>
                  <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ② 회사와 이용자간에 발생한 분쟁에 관한 소송은 민사소송법상의 관할법원에 제기합니다.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">제13조 (데모 서비스)</h2>
              <div className="space-y-4">
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ① 회사는 서비스 이용을 검토하는 고객에게 무료 데모 서비스를 제공할 수 있습니다.
                  </p>
                </div>
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ② 데모 서비스의 기간, 범위 및 기능은 회사가 별도로 정하는 바에 따릅니다.
                  </p>
                </div>
                <div>
                  <p className="text-gray-700 leading-relaxed">
                    ③ 데모 서비스 신청 시 제공한 개인정보는 개인정보처리방침에 따라 처리됩니다.
                  </p>
                </div>
              </div>
            </section>
