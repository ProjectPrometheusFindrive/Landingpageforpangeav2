        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 md:py-14">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-5 leading-tight">
              <span className="text-white">도난, 사고, 미납</span><br />
              <span className="bg-gradient-to-r from-green-300 to-cyan-300 bg-clip-text text-transparent whitespace-nowrap">체계적으로</span><br />
              <span className="bg-gradient-to-r from-green-300 to-cyan-300 bg-clip-text text-transparent whitespace-nowrap">관리되고 있습니까?</span>
            </h1>
